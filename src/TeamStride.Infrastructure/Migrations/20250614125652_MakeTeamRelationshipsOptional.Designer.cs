...
namespace TeamStride.Infrastructure.Migrations
{
    ...
    [Migration("20250614125652_MakeTeamRelationshipsOptional")]
    partial class MakeTeamRelationshipsOptional
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TeamStride.Domain.Entities.AthleteRegistration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AthleteRegistrations");
                });
            ...
            modelBuilder.Entity("TeamStride.Domain.Entities.TeamRegistration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime>("CodeOfConductAcceptedOn")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<Guid?>("TeamRegistrationWindowId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TeamRegistrationWindowId");
            ...
            modelBuilder.Entity("TeamStride.Domain.Entities.TeamRegistrationWindow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("RegistrationPasscode")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("TeamRegistrationWindows");
                });
            ...
            modelBuilder.Entity("TeamStride.Domain.Entities.AthleteRegistration", b =>
                {
                    b.HasOne("TeamStride.Domain.Entities.TeamRegistration", "Registration")
                        .WithMany("Athletes")
            ...
            modelBuilder.Entity("TeamStride.Domain.Entities.TeamRegistration", b =>
                {
                    ...
                    b.HasOne("TeamStride.Domain.Entities.TeamRegistrationWindow", null)
                        .WithMany("Registrations")
                        .HasForeignKey("TeamRegistrationWindowId");
